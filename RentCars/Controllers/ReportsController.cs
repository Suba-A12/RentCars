...
namespace RentCars.Controllers
{
    public class ReportsController : Controller
    {
        ...
        public async Task<IActionResult> Create([Bind("ReportId,Type,GeneratedDate,StaffId")] Report report)
        {
        ...
        [HttpPost]
        [ValidateAntiForgeryToken]
        public async Task<IActionResult> Edit(int id, [Bind("ReportId,Type,GeneratedDate,StaffId")] Report report)
        {
